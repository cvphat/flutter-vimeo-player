...
class RawVimeoPlayer extends StatefulWidget {
  final Key? key;
  final Function(VimeoMetaData metaData) onEnded;
        ...
        return IgnorePointer(
          ...
          child: InAppWebView(
            ...
            initialData: InAppWebViewInitialData(
              data: player(constraints.maxWidth),
              baseUrl: Uri.parse('https://www.vimeo.com'),
              encoding: 'utf-8',
              mimeType: 'text/html',
            ),
                  ...
                  callback: (params) {
                    ...
                    controller.updateValue(
                      controller.value.copyWith(
                        ...
                        videoWidth:
                            double.parse(params.first['width'].toString()),
                        videoHeight:
                    ...
                    callback: (params) {
                      switch (params.first) {
                        ...
                        case -1:
                          ...
                          widget.onEnded(
                            VimeoMetaData(
                              videoDuration: controller.value.videoDuration ==
                                      null
                                  ? Duration()
                                  : Duration(
                                      seconds: controller.value.videoDuration!
                                          .round(),
                                    ),
